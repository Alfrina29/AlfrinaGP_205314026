 ...
 */
public abstract class MessageRouter { //pada class ini mnecakup pesan mengenau router baik ukuran - setting
	...
	public static final int Q_MODE_RANDOM = 1; //mengatur niilai untuk metode antrian acak
	/** Setting value for FIFO queue mode */ 
	public static final int Q_MODE_FIFO = 2; //ini dengan metode fifo
	
	/** Receive return value for OK */ 
	public static final int RCV_OK = 0; //menerima niai balik utuk OK
	/** Receive return value for busy receiver */
	public static final int TRY_LATER_BUSY = 1; //emenrima nilai untuk penerima yang sibuk
	/** Receive return value for an old (already received) message */
	public static final int DENIED_OLD = -1; //menerima nilai bailk untuk pesan lama yang sudah di berikan
	 ...
	 * {@link #B_SIZE_S} setting. Default value is Integer.MAX_VALUE. //ukuran bufer pesan dibaca pada setting B_Size_s
	...
	public Message messageTransferred(String id, DTNHost from) {
		Message incoming = removeFromIncomingBuffer(id, from); //ini memanggil methode mengambil pesan dari buffer
		boolean isFinalRecipient;// final menerima
	 ...
	 */
	protected Message removeFromIncomingBuffer(String id, DTNHost from) { //mengahups pesan yang datang dengan ID tertentu 
	 ...
	 */
	public void deleteMessage(String id, boolean drop) {// ini hapus random?
